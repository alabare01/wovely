...
export default function PrivacyPolicy() {
  return (
    <div style={S.page}>
      ...
      <h2 style={S.h2}>1. What Information Do We Collect?</h2>
      ...
      <h2 style={S.h2}>2. How Do We Process Your Information?</h2>
      ...
      <h2 style={S.h2}>3. When and With Whom Do We Share Your Personal Information?</h2>
      ...
      <h2 style={S.h2}>4. Do We Use Cookies and Other Tracking Technologies?</h2>
      ...
      <h2 style={S.h2}>5. How Do We Handle Your Social Logins?</h2>
      ...
      <h2 style={S.h2}>6. Is Your Information Transferred Internationally?</h2>
      ...
      <h2 style={S.h2}>7. How Long Do We Keep Your Information?</h2>
      ...
      <h2 style={S.h2}>8. Do We Collect Information from Minors?</h2>
      <p style={S.p}>No. We do not knowingly collect data from or market to children under 18 years of age.</p>

      <h2 style={S.h2}>9. What Are Your Privacy Rights?</h2>
      ...
      <h2 style={S.h2}>10. Controls for Do-Not-Track Features?</h2>
      <p style={S.p}>We do not currently respond to DNT browser signals.</p>

      <h2 style={S.h2}>11. Do We Make Updates to This Notice?</h2>
      <p style={S.p}>Yes. We will update this notice as necessary to stay compliant with relevant laws.</p>

      <h2 style={S.h2}>12. How Can You Contact Us About This Notice?</h2>
