      ...
      <div ref={mainScrollRef} style={{flex:1,minWidth:0,overflowY:"auto",display:"flex",flexDirection:"column",background:"transparent"}}>
        ...
        <div style={{padding:"0 40px",height:68,display:"flex",justifyContent:"space-between",alignItems:"center",position:"sticky",top:0,zIndex:20,flexShrink:0,background:"rgba(251,249,255,.86)",backdropFilter:"blur(8px)",WebkitBackdropFilter:"blur(8px)"}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:14,position:"relative"}}>
            <button onClick={()=>setChatOpen(true)} aria-label="Talk to Bev" title="Talk to us" style={{display:"flex",flexDirection:"column",alignItems:"center",gap:1,background:"none",border:0,cursor:"pointer",padding:"2px 4px"}}><svg width="24" height="24" viewBox="0 0 24 24" fill={T.accent} stroke="none"><path d="M12 21s-7.5-4.6-10-9.3C.6 8.3 2.3 4.9 5.7 4.9c2 0 3.3 1.1 4.3 2.5 1-1.4 2.3-2.5 4.3-2.5 3.4 0 5.1 3.4 3.7 6.8C19.5 16.4 12 21 12 21z"/></svg><span style={{fontSize:9,fontWeight:800,color:T.accent,letterSpacing:".5px",textTransform:"uppercase",fontFamily:T.body,lineHeight:1}}>Talk to us</span></button>
