...
export default function TermsOfService() {
  return (
    <div style={S.page}>
      ...
      <h2 style={S.h2}>Agreement to Legal Terms</h2>
      ...
      <h2 style={S.h2}>Intellectual Property Rights</h2>
      ...
      <h2 style={S.h2}>User Representations</h2>
      ...
      <h2 style={S.h2}>User Registration</h2>
      ...
      <h2 style={S.h2}>Purchases and Payment</h2>
      ...
      <h2 style={S.h2}>Contribution License</h2>
      ...
      <h2 style={S.h2}>Services Management</h2>
      ...
      <h2 style={S.h2}>Term and Termination</h2>
      ...
      <h2 style={S.h2}>Dispute Resolution</h2>
